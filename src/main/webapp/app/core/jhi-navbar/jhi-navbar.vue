    ...
    <b-collapse is-nav id="header-tabs">
      <b-navbar-nav class="ml-auto">
        ...
        >
          ...
          <b-dropdown-item to="/decision-definitions">
            <font-awesome-icon icon="asterisk" />
          ...
          <b-dropdown-item to="/tenant">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.tenant')">Tenants</span>
          </b-dropdown-item>
          <b-dropdown-item to="/admin/user-management" active-class="active">
            <font-awesome-icon icon="users" />
            <span v-text="$t('global.menu.admin.userManagement')">User management</span>
          </b-dropdown-item>
          <b-dropdown-item to="/akip-email-connector-config">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.akipEmailConnectorConfig')">Email Connector Config</span>
          </b-dropdown-item>
