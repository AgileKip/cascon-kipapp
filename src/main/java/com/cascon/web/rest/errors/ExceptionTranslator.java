package com.cascon.web.rest.errors;

import com.cascon.web.rest.util.CustomHeaderUtil;
import java.net.URI;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        com.cascon.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        com.cascon.service.UsernameAlreadyUsedException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        com.cascon.service.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleBadRequestErrorException(BadRequestErrorException ex, NativeWebRequest request) {
        return create(ex, request, CustomHeaderUtil.createFailureAlert(applicationName, ex.getErrorKey(), ex.getParams()));
    }

    @ExceptionHandler
    public ResponseEntity<Problem> handleProcessEngineException(ProcessEngineException ex, NativeWebRequest request) {
        Throwable originalCause = ex.getCause().getCause();
        if (originalCause instanceof BadRequestErrorException) {
            BadRequestErrorException badRequestErrorException = (BadRequestErrorException) originalCause;
            return handleBadRequestErrorException(badRequestErrorException, request);
        }
        return create(
            new BadRequestErrorException(ex.getMessage()),
            request,
            CustomHeaderUtil.createFailureAlert(applicationName, ex.getMessage(), new String[] {})
        );
    }
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.cascon");
    }
}
